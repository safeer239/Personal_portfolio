...
const Footer = ({lightmode}) => {
  return (
    <div className='border-b flex md:flex-col justify-center items-center pb-4 border-neutral-800 my-5'>
        <div className={lightmode?'flex flex-col justify-center items-center my-3 md:flex-row text-white text-center text-xl gap-9 md:gap-4':'flex my-3 md:flex-row text-black text-center text-xl gap-9 md:gap-4'}>
          ...
          <p className={lightmode?'text-white text-xl mt-3':'text-black text-xl mt-3'}>© Moahmmed Safeer 2024. | All Rights Reserved. | </p>
    </div>
  )
}
